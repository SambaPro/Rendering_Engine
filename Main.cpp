...
int main()
{
    ...
    /* Initialise Shaders */
    //Shader textureShader("src/shaders/vertex_shader.vs", "src/shaders/colour_shader.fs");
    Shader shader("src/shaders/vertex_shader.vs", "src/shaders/texture_shader.fs");
